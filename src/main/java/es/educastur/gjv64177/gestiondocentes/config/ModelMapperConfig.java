...
public class ModelMapperConfig {
	...
	public ModelMapper modelMapper() {
		...
		guardiaMap.addMapping(src -> src.getHorario()
				.getId(), FaltaDTO::setHorarioId);
		...
		horarioMap.addMapping(src -> src.getAsignatura()
				.getCiclo()
				.getCodigo(), ClaseDTO::setCicloCodigo);
		horarioMap.addMapping(src -> src.getAsignatura()
				.getCurso(), ClaseDTO::setCurso);
		horarioMap.addMapping(scr -> scr.getDocente()
				.getSiglas(), ClaseDTO::setDocenteSiglas);
